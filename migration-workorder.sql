...
create table if not exists work_orders (
  ...
  job_name text, main_image text, shirt_color text,
...
('basic','เสื้อยืดปกติ (MM08)','2510GMT117','Cotton100% semi 32',10,
...
('oversize','เสื้อโอเวอร์ไซส์ ไหล่ตก (MM05)','2508GMT100','Cotton100% comb 20',20,
...
('boxy','เสื้อบ็อกซี่ ไหล่ตก ครอป','2511GMT129','Cotton100% comb 20',30,
...
('babytee','เสื้อเบบี้ที (MM04)','2508GMT099','Cotton100% comb 40 interlock',40,
